        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CalculationUnit = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DrinkItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Quantity = table.Column<float>(type: "real", nullable: false),
                    CalculationUnit = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DrinkId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IngredientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DrinkItems_Drinks_DrinkId",
                        column: x => x.DrinkId,
                        principalTable: "Drinks",
                        principalColumn: "DrinkId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DrinkItems_Ingredients_IngredientId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Cà phê" });

            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "CategoryId", "CategoryName" },
                values: new object[] { 2, "Trà" });

            migrationBuilder.InsertData(
                table: "Category",
                columns: new[] { "CategoryId", "CategoryName" },
                values: new object[] { 3, "Bánh" });

            migrationBuilder.CreateIndex(
                name: "IX_DrinkItems_DrinkId",
                table: "DrinkItems",
                column: "DrinkId");

            migrationBuilder.CreateIndex(
                name: "IX_DrinkItems_IngredientId",
                table: "DrinkItems",
                column: "IngredientId");
